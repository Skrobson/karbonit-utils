...
{
  public:
    explicit BoostSignalProxy(Sig &signal) : signal(signal)
    {
    }
    ...
    auto connect(const Sig::group_type &group, const Sig::slot_type &slot,
                 bs2::connect_position position = bs2::at_back)
    {
    ...
    auto connect_extended(const Sig::group_type &group, const Sig::extended_slot_type &ext_slot,
                          bs2::connect_position position = bs2::at_back)
    {
