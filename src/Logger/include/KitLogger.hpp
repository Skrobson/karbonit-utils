...
#define KIT_LOG_C_E(CHANNEL, ...) kit::logger::LogManager::getInstance().log(CHANNEL, kit::logger::LogLevel::err, __VA_ARGS__);
#define KIT_LOG_C_C(CHANNEL, ...) kit::logger::LogManager::getInstance().log(CHANNEL, kit::logger::LogLevel::critical, __VA_ARGS__);

#define KIT_LOG_T_IF(CONDITION, ...) if(CONDITION) KIT_LOG_T(__VA_ARGS__)
#define KIT_LOG_D_IF(CONDITION, ...) if(CONDITION) KIT_LOG_D(__VA_ARGS__)
#define KIT_LOG_I_IF(CONDITION, ...) if(CONDITION) KIT_LOG_I(__VA_ARGS__)
#define KIT_LOG_W_IF(CONDITION, ...) if(CONDITION) KIT_LOG_W(__VA_ARGS__)
#define KIT_LOG_E_IF(CONDITION, ...) if(CONDITION) KIT_LOG_E(__VA_ARGS__)
#define KIT_LOG_C_IF(CONDITION, ...) if(CONDITION) KIT_LOG_C(__VA_ARGS__)

#define KIT_LOG_C_T_IF(CONDITION, CHANNEL, ...) if(CONDITION) KIT_LOG_C_T(CHANNEL, __VA_ARGS__)
#define KIT_LOG_C_D_IF(CONDITION, CHANNEL, ...) if(CONDITION) KIT_LOG_C_D(CHANNEL, __VA_ARGS__)
#define KIT_LOG_C_I_IF(CONDITION, CHANNEL, ...) if(CONDITION) KIT_LOG_C_I(CHANNEL, __VA_ARGS__)
#define KIT_LOG_C_W_IF(CONDITION, CHANNEL, ...) if(CONDITION) KIT_LOG_C_W(CHANNEL, __VA_ARGS__)
